...
public class Messages {
  ...
  public static final class CreateMessage {
    ...
    public boolean equals(Object o) {
      ...
      return Objects.equals(asset, that.asset) && Objects.equals(uri, that.uri) && Objects.equals(packageName, that.packageName) && Objects.equals(formatHint, that.formatHint) && Objects.equals(audioTrackName, that.audioTrackName) && httpHeaders.equals(that.httpHeaders) && Objects.equals(viewType, that.viewType);
    }

    @Override
    public int hashCode() {
      return Objects.hash(asset, uri, packageName, formatHint, audioTrackName, httpHeaders, viewType);
    }
    ...
    ArrayList<Object> toList() {
      ...
      toListResult.add(audioTrackName);
    ...
    static @NonNull CreateMessage fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      ...
      Object audioTrackName = pigeonVar_list.get(4);
  ...
  public static final class AudioTrackMessage {
    ...
    public @Nullable List<String> getAudioTrackNames() {
  ...
  public interface AndroidVideoPlayerApi {
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable AndroidVideoPlayerApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.getAvailableAudioTracksList" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.setActiveAudioTrack" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.setActiveAudioTrackByIndex" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
