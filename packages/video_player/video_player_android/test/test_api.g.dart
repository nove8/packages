  ...
  static void setup(TestHostVideoPlayerApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    }
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.AndroidVideoPlayerApi.getAvailableAudioTracksList was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final TextureMessage? arg_msg = (args[0] as TextureMessage?);
          assert(arg_msg != null,
              'Argument for dev.flutter.pigeon.AndroidVideoPlayerApi.getAvailableAudioTracksList was null, expected non-null TextureMessage.');
    ...
    }
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.AndroidVideoPlayerApi.setActiveAudioTrack was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final AudioTrackMessage? arg_msg = (args[0] as AudioTrackMessage?);
          assert(arg_msg != null,
              'Argument for dev.flutter.pigeon.AndroidVideoPlayerApi.setActiveAudioTrack was null, expected non-null AudioTrackMessage.');
    ...
    }
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.AndroidVideoPlayerApi.setActiveAudioTrackByIndex was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final AudioTrackMessage? arg_msg = (args[0] as AudioTrackMessage?);
          assert(arg_msg != null,
              'Argument for dev.flutter.pigeon.AndroidVideoPlayerApi.setActiveAudioTrackByIndex was null, expected non-null AudioTrackMessage.');
